...
public class Zadatak2Test {
    ...
    /**
     * Test of jednacina method, of class Zadatak2.
     */
    @Rule
    public ExpectedException exception = ExpectedException.none();
    
    @Test(expected = ArithmeticException.class)  // definisem koju vrstu izuzetka ocekujem da mi metoda jednacina() izbaci
    public void testJednacina1() {
        System.out.println("Testiranje jednacine, slucaj 1: ");
        int x = 0;
        int result = Zadatak2.jednacina(x);
